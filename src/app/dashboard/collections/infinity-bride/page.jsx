...
export default function InfinityBridePage() {
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold">Infinity Bride</h1>
            <Badge variant="secondary">Bridal</Badge>
          </div>
          <p className="text-sm text-muted-foreground mt-0.5">
            For the queen on her most sacred day.
          </p>
        </div>
